...
const Home = () => {
    ...
    return (
        <div>
            <div className="flex flex-col lg:flex-row justify-between lg:justify-center h-[90vh] relative">
                <div className="hidden lg:block absolute top-0 right-0 w-96 h-[500px] bg-primary z-0"></div>
                <div className="gap-0 w-full lg:w-1/2 flex flex-col justify-between lg:pt-12 pt-20">
                    <div className="flex flex-col h-full lg:justify-center">
                        ...
                        <h1 className="text-3xl lg:text-7xl lg:leading-[1.3] font-semibold mt-2 lg:mt-4 mb-4 lg:mb-8">
                            Being Part Of Aid Foundation Is A Way To Share
                        </h1>
                        <p className="text-dark-70 text-sm lg:text-xl lg:leading-8">
                            Share your kindness with the world. By supporting
                            the Aid Foundation, you're not just making a
                            donation, you're investing in the future. Your
                            contributions help fund vital programs, empower
                            communities, and provide hope to those who need it
                            most.
                        </p>
                    </div>

                    <div className="rounded-tr-[84px] w-full row-start-4 bg-primary h-52 flex items-center justify-center p-4 z-10">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center md:ml-10 w-full md:w-1/2 mb-20">
                    <div className="hidden lg:block rounded-[36px] bg-white border border-black relative h-[300px] md:h-[450px] w-full md:w-12/12 mb-6 lg:mb-20 mr-0 md:mr-9 z-10 p-2">
                        <img
                            className="rounded-[28px] h-1/2 object-cover -mb-4"
                    ...
                    <div className="hidden lg:block rounded-[36px] bg-white border border-black relative md:h-[350px] w-full md:w-10/12 mb-20 mr-5 z-10 p-2">
                        <img
                            className="rounded-[28px] h-1/2 object-cover -mb-4"
                            src="https://mi.polinela.ac.id/wp-content/uploads/2021/12/bursa_kerja_it_bootcamp_enigmacamp_d3_mi_polinela.jpg"
                            alt="Campaign 1"
                    ...
                    <div className="flex flex-col-reverse lg:flex-row lg:space-x-5 items-start">
                        <div className="mb-5 md:mt-10">
                            ...
                            <p className="text-[#3d3d3d] text-sm  font-normal mt-5 max-w-md">
                                ...
                                memberikan benda, tetapi juga memberi harapan
                ...
                <div className="h-auto lg:h-[430px] w-[90%] lg:w-[70%] rounded-[100px] mx-4 bg-[#e17052] flex flex-col items-center relative p-6 lg:p-8">
                    <div className="text-center mt-6 mx-4 lg:mx-44">
                        ...
                        <p className="text-white text-sm lg:text-xs font-normal mt-5">
                            In carrying out their duties, charitable foundations
                            provide a variety of social services such as
                    ...
                    <div className="flex flex-col lg:flex-row mt-12 space-y-8 lg:space-y-0 lg:space-x-32 text-center">
                        <div className="flex flex-col items-center text-white">
                            ...
                            <p className="text-xs">
                                Sign up to join and be part of the good people
                                who love to share
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-white">
                            ...
                            <p className="text-xs">
                                There are many things you can choose to share
                                goodness with
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-white">
                            ...
                            <p className="text-xs">
                                Sharing happiness with those less and doing more
                                good for others
                            </p>
                        </div>
                    </div>
