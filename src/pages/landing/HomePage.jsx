...
const HomePage = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            try {
                setIsLoading(true);
                await dispatch(getAllCampaign({ size: 6 })).unwrap();
            ...
            <>
                <section className="flex xl:flex-row flex-col h-[93.5vh] gap-4 relative">
                    ...
                    <div className="w-full xl:w-[55%] hidden xl:flex justify-between h-full pt-16 z-10">
                        ...
                        <div className="flex flex-col translate-y-12 scale-90  w-[340px] p-2 rounded-[32px] border gap-4 bg-light h-max">
                            ...
                            <div className="pb-6 px-3 flex flex-col gap-1">
                                ...
                                <div className="flex justify-center items-center w-full cursor-pointer rounded-full bg-amber-500 py-2">
                                    <h1 className="text-light font-semibold">
                                        Donate Now
                                    </h1>
                                </div>
                ...
                <section className="pt-20 pb-16">
                    ...
                    <div className="mt-10 flex flex-wrap gap-12 justify-center">
                        ...
                        <div className="w-full flex flex-col items-center gap-4 md:w-[45%] lg:w-[30%]">
                            <PiHandsClappingLight size={56} color="#FBBF24" />
                            <h1 className="text-xl font-bold uppercase">
                                Select Donate
                            </h1>
                            <p className="text-center max-w-sm text-sm">
